...
namespace UnityStandardAssets._2D
{
    ...
    public class CameraFollow : MonoBehaviour
    {
        ...
        public Transform follow; // Reference to the player's transform.
        ...
        private bool CheckXMargin()
        {
            ...
            return Mathf.Abs(transform.position.x - offset.x - follow.position.x) > xMargin;
        }
        ...
        private bool CheckZMargin()
        {
            ...
            return Mathf.Abs(transform.position.z - offset.x - follow.position.z) > zMargin;
        }
        ...
        private void TrackPlayer()
        {
            ...
            if (CheckXMargin())
            {
                ...
                targetX = Mathf.Lerp(transform.position.x, follow.position.x, xSmooth*Time.deltaTime);
            }
            ...
            if (CheckZMargin())
            {
                ...
                targetZ = Mathf.Lerp(transform.position.z, follow.position.z, zSmooth*Time.deltaTime);
            }
...
//            targetZ = Mathf.Clamp(targetZ, minXAndZ.z, maxXAndZ.z);
			...
			transform.position = new Vector3(targetX, transform.position.y, targetZ) + offset;
        }
    }
}
